...
mode = input("What mode would you like to run CocoSplit in? (0 = Splitting | 1 = Just Augmentations)\n>")
...
if blurFlag == "0":
    blurAmount = input("What K-size should be used for the blurring? (default is 2)\n>")

# Option to resize images
resizeFlag = input("Resize the images? (0 = Yes | 1 = No):\n>")

if resizeFlag == "0":
    resizeAmount = input("What percentage of the original size should the images be resized to? \n(ex: 100 = 100% of the original size, so no change)\n>")
...
# Flag for random or manual splitting
splitFlag = input("Random splitting or manual splitting? (0 = Random | 1 = Manual)\n>")

# Folder where the data is held
dataFolder = input("What dataset folder is the data in? (train | valid | test)\n>")

################################################

# # Starts the program in background on Lambda
